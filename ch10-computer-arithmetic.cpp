...
int main(int argc, char** argv)
{
  ...
  cout << "sizeof x1: " << sizeof(x1) << endl
       << "address of x1:" << hex << static_cast<void*>(&x1) << dec
       << endl << endl;
  ...
  cout << "value of x1: " << bitset<8>(x1) << " (binary)" 
       << endl << endl;

  uint8_t x2;

  cout << "sizeof x2: " << sizeof(x2) << endl
       << "address of x2: " << hex << static_cast<void*>(&x2) << dec
       << endl << endl;

  x2 = 0;
  cout << "value of x2: " << dec << (int)x2 << " (decimal) " << endl;
  cout << "value of x2: " << bitset<8>(x2) << " (binary)" 
       << endl << endl;
  ...
  cout << "---------- signed 8-bit integers (2s complement) ----------"
       << endl;
  
  int8_t x3;

  cout << "sizeof x3: " << sizeof(x3) << endl
       << "address of x3: " << hex << static_cast<void*>(&x3) << dec
       << endl << endl;

  x3 = 0;
  cout << "value of x3: " << dec << (int)x3 << " (decimal) " << endl;
  cout << "value of x3: " << bitset<8>(x3) << " (binary)" 
       << endl << endl;
  ...
  cout << "sizeof x4: " << sizeof(x4) << endl
       << "address of x4: " << hex << static_cast<void*>(&x4) << dec
       << endl << endl;

  x4 = 0;
  cout << "value of x4: " << dec << (int)x4 << " (decimal) " << endl;
  cout << "value of x4: " << bitset<32>(x4) << " (binary)" 
       << endl << endl;
  ...
  cout << "------------------ signed 32-bit integers -----------------"
       << endl;
  
  int x5;
  
  cout << "sizeof x5: " << sizeof(x5) << endl
       << "address of x5: " << hex << static_cast<void*>(&x5) << dec
       << endl << endl;

  x5 = 97;
  cout << "value of x5: " << dec << (int)x5 << " (decimal) " << endl;
  cout << "value of x5: " << bitset<32>(x5) << " (binary)" 
       << endl << endl;
  ...
  // uint_32 set of bits
  union {float f; uint32_t i; } x6;
  //float x6;
  
  cout << "sizeof x6: " << sizeof(x6) << endl
       << "address of x6: " << hex << static_cast<void*>(&x6) << dec
       << endl << endl;
  ...
  cout << "value of x6: " << endl
       << "     " << floatToBitString(x6.i) << " (binary)" 
       << endl << endl;
